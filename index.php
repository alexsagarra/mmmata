                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="#home">Search</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
                        ...
                        <div class="header-hero-content">
                            ...
                            <div class="header-singup wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
								...
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>#products" method="get">
									<input type="text" placeholder="Apfel" autofocus>
            ...
            <div class="row align-items-end">
                <div class="col-lg-4">
                    <div class="section-title pb-20  wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                        ...
                        <h4 class="title">Informations <span>Data.</span></h4>
                    </div> <!-- section title -->
                </div>
                <div class="col-lg-8">
